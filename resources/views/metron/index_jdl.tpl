...
<html class="no-js" lang="zxx">
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="/theme/jdl/imgm/icon/favicon.png">
        <!-- Place favicon.ico in the root directory -->
		
		<!-- all css here -->
        <link rel="stylesheet" href="/theme/jdl/cssm/bootstrap.min.css">
        <link rel="stylesheet" href="/theme/jdl/cssm/font-awesome.min.css">
        <link rel="stylesheet" href="/theme/jdl/cssm/icofont.css">
        <link rel="stylesheet" href="/theme/jdl/cssm/meanmenu.min.css">
		<link rel="stylesheet" href="/theme/jdl/cssm/slick.css">
        <link rel="stylesheet" href="/theme/jdl/cssm/owl.carousel.css">
        <link rel="stylesheet" href="/theme/jdl/cssm/magnific-popup.css">
        <link rel="stylesheet" href="/theme/jdl/cssm/animate.css">
		<link rel="stylesheet" href="/theme/jdl/cssm/animated-headlines.css">
        <link rel="stylesheet" href="/theme/jdl/cssm/shortcode/shortcodes.css">
        <link rel="stylesheet" href="/theme/jdl/stylem.css">
        <link rel="stylesheet" href="/theme/jdl/cssm/responsive.css">
        <script src="/theme/jdl/jsm/vendor/modernizr-2.8.3.min.js"></script>
		...
		<header>
			<nav id="header-top" class="navbar">
				<div class="container">
					...
					<a class="navbar-brand" href="#"><img src="/theme/jdl/imgm/icon/logo.png" alt="logo"  height="166" width="36" class="img-responsive"></a>
		
					</div>
					<div class="collapse navbar-collapse" id="navigation">
						<ul class="nav navbar-nav navbar-right">
							<li class="active"><a href="#slider-area">首页</a></li>
							<li><a href="#about">产品</a></li>
							<li><a href="#features">优势</a></li>
							<li><a href="#pricing">价格</a></li>
							<li><a href="#client">下载</a></li>
							<!--<li><a href="#team">Team</a></li>-->
							<li><a target="_blank" href="/auth/login">登录</a></li>
		...
		<div class="hero-area slider-4" id="slider-area">
			<div class="slider">
				...
				<div class="slide-animation wow slideInLeft" data-wow-duration="2s" data-wow-delay="1s">
					<img src="/theme/jdl/imgm/slider/10.png" alt="" />
				</div>
			</div>
		</div>
		<!-- hero area end -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="single-service">
							<div class="service-icon">
								<img src="/theme/jdl/imgm/icon/service-icon-1.png" alt="">
							</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="single-service">
							<div class="service-icon">
								<img src="/theme/jdl/imgm/icon/service-icon-2.png" alt="">
							</div>
							<div class="service-content">
								<h2>高速流畅</h2>
					...
					<div class="col-md-4 hidden-sm">
						<div class="single-service">
							<div class="service-icon">
								<img src="/theme/jdl/imgm/icon/service-icon-3.png" alt="">
							</div>
							<div class="service-content">
								<h2>长期运营</h2>
		...
		<section id="about" class="about-area pt-125">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="about-img">
							<img src="/theme/jdl/imgm/other/about.png" alt="" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="how-work-right text-center">
							<img src="/theme/jdl/imgm/other/work.png" alt="" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-12 col-xs-12">
						<div class="screenshot-slider">
							<div class="single-screenshot">
								<div class="image">
									<img src="/theme/jdl/imgm/screenshot/1.png" alt="">
								</div>
							</div>
							<div class="single-screenshot">
								<div class="image">
									<img src="/theme/jdl/imgm/screenshot/2.png" alt="">
								</div>
							</div>
							<div class="single-screenshot">
								<div class="image">
									<img src="/theme/jdl/imgm/screenshot/3.png" alt="">
								</div>
							</div>
							<div class="single-screenshot">
								<div class="image">
									<img src="/theme/jdl/imgm/screenshot/4.png" alt="">
								</div>
							</div>
							<div class="single-screenshot">
								<div class="image">
									<img src="/theme/jdl/imgm/screenshot/5.png" alt="">
								</div>
							</div>
						</div>
					</div>
	...
	-->
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<div class="section-heading pb-55 text-center">
							<h2>倾力打造最具性价比产品</h2>
							<p>多样化、极具性价比的套餐，覆盖不同使用人群，总有一款适合您</p>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="pricing-single white-bg text-center mb-30">
							...
							<div class="pricing-price">
								<span>9.9<p>/月</p><p>29.7元/3个月</p><p>59.9元/6个月</p><p>118.8元/12个月</p></span>
							</div>
							...
							<div class="ordr-btn uppercase">
								<a target="_blank" href="/auth/register">免费使用</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="pricing-single active white-bg text-center mb-30">
							...
							<div class="pricing-price">
								<span>19.9<p>/月</p><p>59.9元/3个月</p><p>109.9元/6个月</p><p>199.9元/12个月</p></span>
							</div>
							<div class="price-decs">
								<ul>
									<li> 100GB 流量 </li>
					...
					<div class="col-md-4 hidden-sm">
						<div class="pricing-single white-bg text-center mb-30">
							...
							<div class="pricing-price">
								<span>29.9<p>/月</p><p>89.9元/3个月</p><p>159.9元/6个月</p><p>299.9元/12个月</p></span>
							</div>
							<div class="price-decs">
								<ul>
									<li>无限流量（1000GB）</li>
				...
				<div class="row">
					<div class="col-md-3 col-sm-6">
						<div class="team-single">
							<img src="/theme/jdl/imgm/team/1.png" alt="" />
					...
					<div class="col-md-3 col-sm-6">
						<div class="team-single">
							<img src="/theme/jdl/imgm/team/2.png" alt="" />
							<div class="team-overlay text-center">
								<h5>Kausar</h5>
								<h6>娱乐爱好者</h6>
						    </div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="team-single">
							<img src="/theme/jdl/imgm/team/3.png" alt="" />
							<div class="team-overlay text-center">
								<h5>Nirob</h5>
								<h6>币圈投资者</h6>
						    </div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="team-single">
							<img src="/theme/jdl/imgm/team/4.png" alt="" />
							<div class="team-overlay text-center">
								<h5>Rana</h5>
								<h6>外贸工作者</h6>
						    </div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="download-option-btn text-center">
							<ul>
								<li>
									<a href="/vpn/downloads/ClashX.dmg"><i class="icofont icofont-brand-apple"></i> MacOS </a>
									<a class="active" href="/vpn/downloads/Clash.for.Windows-0.9.1-win.7z"><i class="icofont icofont-brand-windows"></i> Windows </a>
									<a href="/user/tutorial?os=ios&client=shadowrocket"><i class="icofont icofont-brand-apple"></i> App Store</a>
									<a href="/vpn/downloads/clash-for-android.apk"><i class="icofont icofont-brand-android-robot"></i> Android</a>
								</li>
							</ul>
						</div>
					</div>
	   ...
	   -->
					...
					<div class="col-md-12">
						<div class="copyright-area text-center">
							...
							<div class="contact-social text-center pt-70 pb-35">
								<ul>
									<li>
																		<a target="_blank" href="https://t.me/vpn200g1"><i class="icofont icofont-social-facebook"></i></a>
									 
									</li>
									<li>
																		<a target="_blank" href="https://t.me/vpn200g1"><i class="icofont icofont-social-twitter"></i></a>
									 

									</li>
									<li>

																			<a target="_blank" href="https://t.me/vpn200g1"><i class="icofont icofont-social-pinterest"></i></a>
									 									</li>
									<li>

																			<a target="_blank" href="https://t.me/vpn200g1"><i class="icofont icofont-social-vimeo"></i></a>
									 									</li>
									<li>

																			<a target="_blank" href="https://t.me/vpn200g1"><i class="icofont icofont-social-google-plus"></i></a>
									 									</li>
								</ul>
							</div>
							<!-- Copyright social -->
							<div class="copyright-text">
								<p>Copyright &copy;  <a href="#"> Devitems. </a> All Rights Reserved.</p>
							</div>
							<!-- Copyright text -->
						</div>
					</div>
		...
		<!-- all js here -->
        <script src="/theme/jdl/jsm/jquery-1.12.4.min.js"></script>
        <script src="/theme/jdl/jsm/bootstrap.min.js"></script>
        <script src="/theme/jdl/jsm/owl.carousel.min.js"></script>
		<script src="/theme/jdl/jsm/slick.min.js"></script>
        <script src="/theme/jdl/jsm/jquery.ajaxchimp.min.js"></script>
        <script src="/theme/jdl/jsm/plugins.js"></script>
        <script src="/theme/jdl/jsm/main.js"></script>
		<!-- map js -->
		...
		<script>
			...
			function initialize() {
			  ...
			  var marker = new google.maps.Marker({
				...
				icon: '/theme/jdl/imgm/icon/map-icon.png',
				map: map
			  });
			}
